...
//  понадобится сделать отдельный класс и два теста: для проверки успешной загрузки и для проверки ошибки.
class MoviesLoaderTest: XCTestCase {
    
    // создаем тесттовую версию сетевого клиента (стаб - заглушка)
